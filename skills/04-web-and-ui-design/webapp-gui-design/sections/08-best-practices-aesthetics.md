...
When the request is for dashboards, admin panels, SaaS apps, tools, settings pages, or data interfaces, follow the Interface Design workflow in [09-interface-design.md](09-interface-design.md) before proposing a direction or writing UI code.
